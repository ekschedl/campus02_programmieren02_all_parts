...
//        buchPrinter.print(buch);
    InfiniteGenericsBox<Integer> integerInfiniteGenericsBox=new InfiniteGenericsBox<>();
    integerInfiniteGenericsBox.putItem(17);
    integerInfiniteGenericsBox.putItem(17);
    integerInfiniteGenericsBox.putItem(17);
    integerInfiniteGenericsBox.putItem(17);
    integerInfiniteGenericsBox.putItem(17);
    ...
    integerInfiniteGenericsBox.putItem(17);
    integerInfiniteGenericsBox.putItem(17);
    integerInfiniteGenericsBox.printContents();
//
   }
}
